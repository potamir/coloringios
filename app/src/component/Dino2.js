...
export default class Dino2 extends Component {
  constructor(props){
    super(props);  
  }
  ...
  addData= (number, data) =>
  {
    switch (number){
      case  1:
          this.props.dinoStore.setLastPointStr1(data);
          break;

      case  2:
          this.props.dinoStore.setLastPointStr2(data);
          break;

      case  3:
          this.props.dinoStore.setLastPointStr3(data);
          break;

      case  4:
          this.props.dinoStore.setLastPointStr4(data);
          break;

      case  5:
          this.props.dinoStore.setLastPointStr5(data);
          break;

      case  6:
          this.props.dinoStore.setLastPointStr6(data);
          break;

      case  7:
          this.props.dinoStore.setLastPointStr7(data);
          break;

      case  8:
          this.props.dinoStore.setLastPointStr8(data);
          break;

      case  9:
          this.props.dinoStore.setLastPointStr9(data);
          break;

      case  10:
          this.props.dinoStore.setLastPointStr10(data);
          break;

      case  16:
          this.props.dinoStore.setLastPointStr16(data);
          break;

      case  17:
          this.props.dinoStore.setLastPointStr17(data);
          break;

      case  18:
          this.props.dinoStore.setLastPointStr18(data);
          break;

      case  19:
          this.props.dinoStore.setLastPointStr19(data);
          break;
  ...
  addPoint= (number, data) =>
  {
    switch (number){
      case  1:
          this.props.dinoStore.addPointStr1({color:this.props.mau, data: data });
          break;

      case  2:
          this.props.dinoStore.addPointStr2({color:this.props.mau, data: data });
          break;

      case  3:
          this.props.dinoStore.addPointStr3({color:this.props.mau, data: data });
          break;

      case  4:
          this.props.dinoStore.addPointStr4({color:this.props.mau, data: data });
          break;

      case  5:
          this.props.dinoStore.addPointStr5({color:this.props.mau, data: data });
          break;

      case  6:
          this.props.dinoStore.addPointStr6({color:this.props.mau, data: data });
          break;

      case  7:
          this.props.dinoStore.addPointStr7({color:this.props.mau, data: data });
          break;

      case  8:
          this.props.dinoStore.addPointStr8({color:this.props.mau, data: data });
          break;

      case  9:
          this.props.dinoStore.addPointStr9({color:this.props.mau, data: data });
          break;

      case  10:
          this.props.dinoStore.addPointStr10({color:this.props.mau, data: data });
          break;

      case  16:
          this.props.dinoStore.addPointStr16({color:this.props.mau, data: data });
          break;

      case  17:
          this.props.dinoStore.addPointStr17({color:this.props.mau, data: data });
          break;

      case  18:
          this.props.dinoStore.addPointStr18({color:this.props.mau, data: data });
          break;

      case  19:
          this.props.dinoStore.addPointStr19({color:this.props.mau, data: data });
          break;
      ...
      <Svg height="100%" width="100%" >
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 1)} onResponderGrant={(e) => this._Press(e, 1)} onResponderRelease={(e) => this._Release(e, 1)} >
          ...
          <G clipPath="url(#clip-1)">
            {
              this.props.dinoStore.pointStr1.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 2)} onResponderGrant={(e) => this._Press(e, 2)} onResponderRelease={(e) => this._Release(e, 2)} >
          ...
          <G clipPath="url(#clip-2)">
            {
              this.props.dinoStore.pointStr2.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 3)} onResponderGrant={(e) => this._Press(e, 3)} onResponderRelease={(e) => this._Release(e, 3)} >
          ...
          <G clipPath="url(#clip-3)">
             {
              this.props.dinoStore.pointStr3.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 4)} onResponderGrant={(e) => this._Press(e, 4)} onResponderRelease={(e) => this._Release(e, 4)} >
         ...
         <Use href="#shape_4" fill="white"/>
          ...
          <G clipPath="url(#clip-4)">
             {
              this.props.dinoStore.pointStr4.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 5)} onResponderGrant={(e) => this._Press(e, 5)} onResponderRelease={(e) => this._Release(e, 5)} >
          ...
          <G clipPath="url(#clip-5)">
             {
              this.props.dinoStore.pointStr5.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 6)} onResponderGrant={(e) => this._Press(e, 6)} onResponderRelease={(e) => this._Release(e, 6)} >
          ...
          <G clipPath="url(#clip-6)">
             {
              this.props.dinoStore.pointStr6.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 7)} onResponderGrant={(e) => this._Press(e, 7)} onResponderRelease={(e) => this._Release(e, 7)} >
          ...
          <G clipPath="url(#clip-7)">
           {
              this.props.dinoStore.pointStr7.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 8)} onResponderGrant={(e) => this._Press(e, 8)} onResponderRelease={(e) => this._Release(e, 8)} >
          ...
          <G clipPath="url(#clip-8)">
            {
              this.props.dinoStore.pointStr8.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 9)} onResponderGrant={(e) => this._Press(e, 9)} onResponderRelease={(e) => this._Release(e, 9)} >
         ...
         <Use href="#shape_9" fill="white"/>
          ...
          <G clipPath="url(#clip-9)">
            {
              this.props.dinoStore.pointStr9.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 10)} onResponderGrant={(e) => this._Press(e, 10)} onResponderRelease={(e) => this._Release(e, 10)} >
         ...
         <Use href="#shape_10" fill="white"/>
          ...
          <G clipPath="url(#clip-10)">
            {
              this.props.dinoStore.pointStr10.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 16)} onResponderGrant={(e) => this._Press(e, 16)} onResponderRelease={(e) => this._Release(e, 16)} >
          ...
          <G clipPath="url(#clip-16)">
            {
              this.props.dinoStore.pointStr16.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 17)} onResponderGrant={(e) => this._Press(e, 17)} onResponderRelease={(e) => this._Release(e, 17)} >
          ...
          <G clipPath="url(#clip-17)">
            {
              this.props.dinoStore.pointStr17.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 18)} onResponderGrant={(e) => this._Press(e, 18)} onResponderRelease={(e) => this._Release(e, 18)} >
         ...
         <Use href="#shape_18" fill="white"/>
          ...
          <G clipPath="url(#clip-18)">
            {
              this.props.dinoStore.pointStr18.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
        ...
        <G onMoveShouldSetResponder={() => true} onStartShouldSetResponder={() => true} onResponderMove={(e) => this._Move(e, 19)} onResponderGrant={(e) => this._Press(e, 19)} onResponderRelease={(e) => this._Release(e, 19)} >
         ...
         <Use href="#shape_19" fill="white"/>
          ...
          <G clipPath="url(#clip-19)">
            {
              this.props.dinoStore.pointStr19.map((item, index) =>
                <Path
                  key={index}
                  d={item.data}
                  fill="none"
